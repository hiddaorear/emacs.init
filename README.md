...
`subword-mode`默认开启，导致单词以大小写分割，在驼峰命名的时候，快速选中单词或者搜索，不方便。可以使用指令`subword-mode`关闭。

这是从vim转到emacs时，非常难适应的一个点，vim使用`#`可以直接选中光标下的单词，而`subword-mode`开启之后，选中的单词以驼峰分割了，这样搜索并非本意。
...
- 2020/10/25 晚上，小豆豆睡觉，回忆工作受累，想当初编程，从玩emacs开始，重回初心，聊以自娱
